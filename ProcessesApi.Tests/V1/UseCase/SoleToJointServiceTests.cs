...
namespace ProcessesApi.Tests.V1.UseCase
{
    ...
    public class SoleToJointServiceTests : IDisposable
    {
        ...
        public async Task ProcessClosedEventIsRaisedWhenAutomaticEligibilityChecksFail()
        {
            ...
            snsEvent.EventType.Should().Be(ProcessEventConstants.PROCESS_CLOSED_EVENT);
        }
        ...
        public async Task ProcessStateIsUpdatedToDocumentsRequestedDesOnRequestDocumentsDesTrigger()
        {
            ...
            CurrentStateShouldContainCorrectData(
                ...
                new List<string> { SoleToJointPermittedTriggers.RequestDocumentsAppointment /* TODO: VK: Update permitted triggers when implemented */ });
        ...
        public async Task ProcessUpdatedEventIsRaisedWhenDocumentsRequestedViaDes()
        {
            ...
            _lastSnsEvent.EventData.NewData.Should().BeOfType<string>();
        }
        ...
        public async Task ProcessStateIsUpdatedToDocumentsRequestedAppointmentOnRequestDocumentsAppointmentTrigger()
        {
            ...
            CurrentStateShouldContainCorrectData(
                ...
                new List<string> { SoleToJointPermittedTriggers.RescheduleDocumentsAppointment /* TODO: VK: Update permitted when implemented */});
        ...
        {
            // Arrange
            var appointmentDateTime = DateTime.UtcNow.ToIsoString();
            ...
            _lastSnsEvent.EventType.Should().Be(ProcessEventConstants.PROCESS_UPDATED_EVENT);
            _lastSnsEvent.EventData.NewData.Should().BeOfType<RequestAppointmentEventData>();

            ((RequestAppointmentEventData) _lastSnsEvent.EventData.NewData).Description.Should().NotBeNullOrEmpty();
            ((RequestAppointmentEventData) _lastSnsEvent.EventData.NewData).DateTime.Should().Be(appointmentDateTime);
        }
        ...
        public async Task ProcessUpdatedEventIsRaisedWhenDocumentsAppointmentIsRescheduled()
        {
            ...
            _lastSnsEvent.EventType.Should().Be(ProcessEventConstants.PROCESS_UPDATED_EVENT);
            _lastSnsEvent.EventData.OldData.Should().Be(oldAppointmentDateTime);
            _lastSnsEvent.EventData.NewData.Should().BeOfType<RequestAppointmentEventData>();

            ((RequestAppointmentEventData) _lastSnsEvent.EventData.NewData).Description.Should().NotBeNullOrEmpty();
            ((RequestAppointmentEventData) _lastSnsEvent.EventData.NewData).DateTime.Should().Be(newAppointmentDateTime);
        }
        ...
        #endregion Tenancy breach checks
    }
}
