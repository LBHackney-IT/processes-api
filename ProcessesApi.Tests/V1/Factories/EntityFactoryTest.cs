...
namespace ProcessesApi.Tests.V1.Factories
{
    public class EntityFactoryTest
    {
        ...
        public void CanMapADatabaseEntityToADomainObject()
        {
            ...
            var entity = Process.Create(Guid.NewGuid(), new List<ProcessState>(), null, Guid.NewGuid(), TargetType.tenure, new List<RelatedEntities>(), ProcessName.soletojoint, null);
        ...
        {
            var entity = Process.Create(Guid.NewGuid(), new List<ProcessState>(), null, Guid.NewGuid(), TargetType.asset, new List<RelatedEntities>(), ProcessName.soletojoint, null);
            var databaseEntity = entity.ToDatabase();
