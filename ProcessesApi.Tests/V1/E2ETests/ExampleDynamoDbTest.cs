...
//{
// For guidance on writing integration tests see the wiki page https://github.com/LBHackney-IT/lbh-processes-api/wiki/Writing-Integration-Tests
...
//        var uri = new Uri($"api/v1/processes/{id}", UriKind.Relative);
...
//        //TODO: Update uri route to match the APIs endpoint
//        var uri = new Uri($"api/v1/processes/{entity.Id}", UriKind.Relative);
//        var response = await Client.GetAsync(uri).ConfigureAwait(false);
