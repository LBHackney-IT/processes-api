...
namespace ProcessesApi.Tests.V1.E2ETests.Steps
{
    public class UpdateProcessByIdSteps : BaseSteps
    {
        ...
        public async Task WhenAnUpdateProcessByIdRequestIsMade(UpdateProcessQuery request, UpdateProcessByIdRequestObject requestBody, int? ifMatch)
        {
        ...
        public async Task ThenTheProcessDataIsUpdated(UpdateProcessQuery request, UpdateProcessByIdRequestObject requestBody)
        {
